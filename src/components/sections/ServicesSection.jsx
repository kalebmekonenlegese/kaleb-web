...
import { consultationCta } from "../../data/siteData";
    ...
    <section id="services" className="py-16 sm:py-20 lg:py-24">
      <div className="section-shell">
        ...
        >
          ...
          <h2 className="section-title mt-5">Services That Help Your Business Grow</h2>
        ...
        >
          ...
          <a
            href={consultationCta.button.href}
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto pt-8">
        <a
          href="#contact"
          className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:border-sky-300/40 hover:bg-white/10"
        >
          {service.cta}
        </a>
      </div>
